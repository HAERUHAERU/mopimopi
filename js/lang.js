l = {
    Notice: {
        ...
        tip: {
            KR: '[OFFICIAL] MopiMopi ver.211219 / 해루@모그리',
            EN: '[OFFICIAL] MopiMopi ver.211219 / HAERU@Moogle (KR)'
        },
        update: {
            KR: '<div name="row"><div class="c">12/19</div><div class="m">[요정셀레네@초코보] 6.0 백마도사 데이터 수정</div></div><div name="row"><div class="u">12/13</div><div class="m">[오미루@모그리] 6.0 카벙클 추가</div></div><div name="row"><div class="c">12/12</div><div class="m">[오미루@모그리] 6.0 리미트 브레이크 데이터 변경</div></div><div name="row"><div class="u">12/09</div><div class="m">[오미루@모그리] 6.0 신규 펫 데이터 추가 (SMN)</div></div><div name="row"><div class="u">12/03</div><div class="m">[오미루@모그리] 6.0 신규 직업 아이콘 추가 (RPR/SGE)</div></div><div name="row"><div class="b">12/03</div><div class="m">6.0 신규 펫이나 기술 이름 제보 바랍니다. <a href="https://docs.google.com/spreadsheets/d/1Cqni0rjvQLnXjK2dhx95xk_NOIIWXt9PK8-2gez5pTI/edit#gid=0" target="_blank">▶▶▶ 데이터 제보하기</a></div></div><div name="row"><div class="u">11/30</div><div class="m">6.0 신규 직업 데이터 추가 (RPR/SGE)</div></div><div name="row"><div class="c">04/01</div><div class="m">[Matthew Smith/Gmail] 축약어를 변경함<Br>(RD → Total DPS, RH → Total HPS, MD → My DPS, MH → My HPS)</div></div><div name="row"><div class="n">01/01</div><div class="m">★★★ 2021년에도 모피모피와 함께! 새해 복 많이 받으세요! ★★★</div></div>',
            EN: '<div name="row"><div class="c">12/19</div><div class="m">[Fairy Selene@Asura/Mana] WHM data modified</div></div><div name="row"><div class="u">12/13</div><div class="m">[Oh Miru@Anima/Mana] Added 6.0 Carbuncle</div></div><div name="row"><div class="c">12/12</div><div class="m">[Oh Miru@Anima/Mana] Changed Limit Break data</div></div><div name="row"><div class="u">12/09</div><div class="m">[Oh Miru@Anima/Mana] Added data of new pets (SMN)</div></div><div name="row"><div class="u">12/03</div><div class="m">[Oh Miru@Anima/Mana] Added icon of new jobs (RPR/SGE)</div></div><div name="row"><div class="b">12/03</div><div class="m">Please report 6.0 pets or actions name. <a href="https://docs.google.com/spreadsheets/d/1Cqni0rjvQLnXjK2dhx95xk_NOIIWXt9PK8-2gez5pTI/edit#gid=0" target="_blank">▶▶▶ Report link</a></div></div><div name="row"><div class="u">11/30</div><div class="m">Added data of new jobs (RPR/SGE)</div></div><div name="row"><div class="c">04/01</div><div class="m">[Matthew Smith/Gmail] Change Abbreviations<Br>(RD → Total DPS, RH → Total HPS, MD → My DPS, MH → My HPS)</div></div><div name="row"><div class="n">01/01</div><div class="m">★★★ 2021 Best wishes for a Happy New Year! ★★★</div></div>'
        }
    },
    msg: {
        comma: {
    ...
    Settings: {
        ...
        Version: {
            ...
            m: {
                KR: 'MopiMopi ver.211219',
                JP: 'MopiMopi ver.211219',
                EN: 'MopiMopi ver.211219',
                FR: 'MopiMopi ver.211219',
                DE: 'MopiMopi ver.211219',
                CN: "MopiMopi ver.211219",
            },
            i: "new_releases",
            e: "li_2line",
            ul: 1
