l = {
    Notice: {
        ...
        update: {
            KR: '<div name="row"><div class="u">19/07/05</div><div class="m">[인벤/Stellalight] 5.0 신규 소환수 데이터 추가</div></div><div name="row"><div class="b">19/06/30</div><div class="m">[twitch/Armell] 이니셜 표시 오류</div></div><div name="row"><div class="u">19/06/28</div><div class="m">[노래하는혼@모그리] 5.0 patch Gunbreaker/Dancer 아이콘 세트 추가</div></div><div name="row"><div class="n">19/03/14</div><div class="m">★★★ 모피모피 벌써 2주년! 항상 감사드립니다! ★★★</div></div><div name="row"><div class="u">19/01/22</div><div class="m">[이솜@모그리] 4.5 patch 청마도사 아이콘 세트 추가</div></div><div name="row"><div class="b">19/01/02</div><div class="m">레이드 모드 : 직업 아이콘 클릭 시 캐릭터 이름 숨김 오류 </div></div><div name="row"><div class="b">19/01/02</div><div class="m">레이드 모드 : 직업 아이콘 크기 조절 오류</div></div><div name="row"><div class="u">19/01/02</div><div class="m">[Gmail/Mark Megyeri] 디자인 ❯ 레이드 모드 (커스터마이징 옵션 추가)</div></div><div name="row"><div class="n">19/01/01</div><div class="m">★★★ 2019년에도 모피모피와 함께! 새해 복 많이 받으세요! ★★★</div></div>',
            EN: '<div name="row"><div class="u">19/07/05</div><div class="m">[Inven/Stellalight] Added the data of NEW 5.0 PET</div></div><div name="row"><div class="b">19/06/30</div><div class="m">[twitch/Armell] Display Error of Initial</div></div><div name="row"><div class="u">19/06/28</div><div class="m">[KR/노래하는혼@모그리] Added the icon sets of Gunbreaker/Dancer for 5.0 patch</div></div><div name="row"><div class="u">19/01/22</div><div class="m">[KR/이솜@모그리] Added the icon sets of Blue Mage for 4.5 patch</div></div><div name="row"><div class="n">19/03/14</div><div class="m">★★★ 2nd anniversary of MopiMopi! Thank you for using it! ★★★</div></div><div name="row"><div class="b">19/01/02</div><div class="m">Raid Mode : Hidden Error of Character name (when click the job icon)</div></div><div name="row"><div class="b">19/01/02</div><div class="m">Raid Mode : Resizing Error of Job icon</div></div><div name="row"><div class="u">19/01/02</div><div class="m">[Gmail/Mark Megyeri] Design ❯ Raid Mode (Added customizing options, Sorry for late...T^T)</div></div><div name="row"><div class="n">19/01/01</div><div class="m">★★★ 2/0/1/9! Best wishes for a Happy New Year! ★★★</div></div>'
        }
    },
    msg: {
        comma: {
