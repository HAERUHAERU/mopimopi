l = {
    Notice: {
        strong: {
            KR: '<b style="color:#ffbb00">모피모피 2<br>놀라운 커스터마이징을 경험하세요!</b><br><br>안녕하세요. FFXIV KR 모그리 서버 해루입니다.<br>기능 추가와 구조 변경 그리고 최신 플러그인 대응을 위해,<br><b>2018년 7월 21일 이후 설정 데이터를 1회 초기화합니다.</b><br>이용에 불편을 드려 죄송합니다.<br><br>아이폰과 아이패드 유저는 <a href="https://github.com/ZCube/ACTWebSocket/releases" target="_blank">ACTWebSocket 1.3.3.9 버전 이상</a>을 설치해야 합니다.<br>모바일 환경에서는 <b>크롬 또는 사파리</b> 앱을 권장합니다.',
            EN: "<b style='color:#ffbb00'>MopiMopi 2<br>Experience the Incredible Customizing!</b><br><br>Hello, I'm Haeru from FFXIV KR Moogle.<br><b>The setup data is initialized once after July 21th</b><br>in order to add features, change the structure and support the latest plugin.<br>Sorry for the inconvenience.<br><br>iPhone and iPad users should install the <a href='https://github.com/ZCube/ACTWebSocket/releases' target='_blank'>ACTWebsocket 1.3.3.9 or higher</a> version.<br><b>Chrome or Safari</b> apps are recommended for mobile environment."
        },
        tip: {
