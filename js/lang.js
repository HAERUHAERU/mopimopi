l = {
    Notice: {
        ...
        update: {
            KR: '<div name="row"><div class="c">05/14</div><div class="m">화면이 변경되지 않는 유저들은 캐시 폴더를 삭제하고 다시 실행해 봅니다.</div></div><div name="row"><div class="c">05/14</div><div class="m">OverlayPlugin : 시작 → 실행 → %appdata% → Advanced Combat Tracker → OverlayPluginCache 폴더 삭제</div></div><div name="row"><div class="c">05/14</div><div class="m">ACTWebSocket : ACT 폴더 → Plugins → ACTWebSocket → overlay_proc → cache 폴더 삭제</div></div>',
            EN: '<div name="row"><div class="c">May 14</div><div class="m">Users whose screen doesn\'t change, delete the cache folder and try again.</div></div><div name="row"><div class="c">May 14</div><div class="m">OverlayPlugin :  %appdata% → Advanced Combat Tracker → OverlayPluginCache directory delete</div></div><div name="row"><div class="c">May 14</div><div class="m">ACTWebSocket : ACT Directory → Plugins → ACTWebSocket → overlay_proc → cache directory delete</div></div>'
        }
    },
    msg: {
        comma: {
