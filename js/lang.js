l = {
    Notice: {
        ...
        update: {
            KR: '<div name="row"><div class="c">05/22</div><div class="m">ACTWebSocket으로 더이상 모피모피를 이용하지 마십시오. OverlayPlugin으로 연결하시기 바랍니다.</div></div><div name="row"><div class="c">05/16</div><div class="m">대기모드 이후 테이블이 보이지 않던 버그를 수정했습니다. (Thanks to Activisionshine)</div></div><div name="row"><div class="c">05/14</div><div class="m">화면이 변경되지 않는 유저들은 캐시 폴더를 삭제하고 다시 실행해 봅니다.</div></div><div name="row"><div class="c">05/14</div><div class="m">OverlayPlugin : 시작 → 실행 → %appdata% → Advanced Combat Tracker → OverlayPluginCache 폴더 삭제</div></div>',
            EN: '<div name="row"><div class="c">May 22</div><div class="m">Do NOT use MopiMopi with ACTWebSocket anymore. Please connect to OverlayPlugin.</div></div><div name="row"><div class="c">May 16</div><div class="m">Fixed a bug where the table was not visible after standby mode. (Thanks to Activisionshine)</div></div><div name="row"><div class="c">May 14</div><div class="m">Users whose screen doesn\'t change, delete the cache folder and try again.</div></div><div name="row"><div class="c">May 14</div><div class="m">OverlayPlugin :  %appdata% → Advanced Combat Tracker → OverlayPluginCache directory delete</div></div>'
        }
    },
    msg: {
        comma: {
